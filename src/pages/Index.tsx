...
const Index = () => {
  const machines = [
    ...
    {
      id: 2,
      title: "Станок для протяжки по трафарету",
      subtitle: "нанесение составов на термопанели через трафарет",
      image: "https://cdn.poehali.dev/files/456ccf6d-c489-4685-967a-e2d763711135.png",
      specs: [
    ...
    {
      id: 3,
      title: "Станок для протяжки термопанелей и гибкого камня",
      subtitle: "собственная разработка для нанесения составов",
      image: "https://cdn.poehali.dev/files/778b8908-99fa-486d-be5c-997b52b9995b.png",
      specs: [
        "Рабочее поле: 3000×1200 мм",
        "Регулировка скорости, высоты и ширины бункера",
        "Управление с брелка",
        "Равномерное разглаживание состава",
        "Для термопанелей, гибкого камня, кирпича, доски",
        "Срок изготовления: 15-30 дней",
        "Отправка ТК в любые регионы"
      ],
      price: "По запросу"
    }
  ];
