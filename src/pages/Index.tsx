...
const Index = () => {
  const machines = [
    ...
    {
      id: 2,
      title: "Станок для протяжки 1-го слоя",
      subtitle: "базовый слой термопанели",
      image: "https://cdn.poehali.dev/projects/b72ccffc-1ade-458f-8ea6-813f2d544224/files/b506319b-831f-40ce-9561-2feda2e079e4.jpg",
      specs: [
        "Производительность: до 500 м²/смену",
        "Толщина слоя: 3-8 мм",
        "Ширина протяжки: до 1200 мм",
